                        ...
                        <div className="space-y-10 text-sm leading-relaxed text-gray-700 md:text-base">
                            <section className="space-y-3">
                                ...
                                <ul className="list-disc space-y-2 pl-6">
                                    <li>
                                        <span className="font-medium text-green-700">Account request details:</span> to request clinic portal access via the homepage contact form, you will be asked to submit your Holy Name University student or employee status, school or employee ID, and a school email address for receiving your account credentials.
                                    </li>
                                    <li>
                                        <span className="font-medium text-green-700">Account and health records:</span> clinic staff may add or update appointment bookings, consultation notes, medical certificates, and other campus clinic documentation tied to your profile.
                                    </li>
                                    <li>
                            ...
                            <section className="space-y-3">
                                ...
                                <ul className="list-disc space-y-2 pl-6">
                                    ...
                                    <li>Ensure accurate matching to the correct patient or employee record so staff can schedule visits, record consultations, manage medical supplies, and generate medical certificates.</li>
                                    <li>Send transactional emails covering appointment updates, visit summaries, and password reset codes through the Gmail API to keep patients informed.</li>
                            ...
                            <section className="space-y-3">
                                ...
                                <p>
                                    Clinic accounts are provisioned by the nurse. Eligible users can request access through the homepage contact form by sharing their full name, campus role, Holy Name University student or employee ID, gender, and date of birth. The nurse reviews each request and, once approved, sends the username (matching the provided ID) and a temporary password to the institutional email address on file. You must change that password after your first sign-in.
                                </p>
                                <p>
                            ...
                            <section className="space-y-3">
                                ...
                                <p>
                                    The application encrypts data both in transit and at rest. Role-based permissions restrict access to sensitive records, ensuring only authorized clinic personnel can view or modify information.
                                </p>
                                <p>
