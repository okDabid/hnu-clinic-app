...
export default function HomePage() {
  return (
    <div className="flex flex-col min-h-screen bg-green-50">
      {/* Header */}
      <header className="w-full py-4 px-4 md:px-8 flex flex-wrap md:flex-nowrap justify-between items-center bg-white shadow gap-4">
        <div className="flex items-center gap-3">
          <img src="/clinic-illustration.svg" alt="logo" className="w-16 md:w-20" />
          <h1 className="text-xl md:text-2xl font-bold text-green-600">HNU Clinic</h1>
        </div>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <Card className="rounded-2xl shadow-lg">
            <CardContent className="p-6 md:p-8 text-center">
              ...
              <p className="text-gray-600 text-sm md:text-base">Access and manage your medical history securely in one place.</p>
            </CardContent>
          </Card>
          ...
          <Card className="rounded-2xl shadow-lg">
            <CardContent className="p-6 md:p-8 text-center">
              ...
              <p className="text-gray-600 text-sm md:text-base">Stay in touch with your healthcare providers for better care.</p>
            </CardContent>
          </Card>
        </div>
      </section>
