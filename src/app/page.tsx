...
// Lazy load lucide icons for performance
...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <header className="w-full border-b bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4 md:px-8 py-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-lg md:text-2xl font-bold text-primary">HNU Clinic</h1>
          </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
            <Card className="rounded-xl shadow-sm hover:shadow-md transition">
              <CardContent className="p-6 md:p-8 text-center space-y-3">
                <CalendarDays className="w-10 h-10 md:w-12 md:h-12 mx-auto text-primary" />
            ...
            <Card className="rounded-xl shadow-sm hover:shadow-md transition">
              <CardContent className="p-6 md:p-8 text-center space-y-3">
                <ClipboardList className="w-10 h-10 md:w-12 md:h-12 mx-auto text-primary" />
            ...
            <Card className="rounded-xl shadow-sm hover:shadow-md transition">
              <CardContent className="p-6 md:p-8 text-center space-y-3">
                <Stethoscope className="w-10 h-10 md:w-12 md:h-12 mx-auto text-primary" />
      ...
      {/* Contact */}
      <section id="contact" className="py-16 md:py-20 px-6 md:px-12 bg-muted/50">
        <div className="max-w-xl mx-auto space-y-4">
          ...
          <Button className="w-full p-4 md:p-6">Send Message</Button>
        </div>
      </section>

      {/* Footer */}
      <footer className="bg-white py-6 text-center text-muted-foreground text-sm md:text-base border-t">
