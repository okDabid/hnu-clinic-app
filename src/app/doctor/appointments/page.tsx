...
export default function DoctorAppointmentsPage() {
    ...
    async function handleGenerateCertificate(appointment: Appointment) {
        if (specialization !== "Physician") {
            toast.error("Medical certificates can only be generated by physicians.");
            return;
        }
        ...
        try {
            ...
            const prefix = "medical-certificate";
            link.href = url;
    ...
    return (
        ...
        >
            <div className="mx-auto flex w-full flex-col gap-6 px-4 sm:px-6">
                                ...
                                <TableBody>
                                    {loading ? (
                                        ...
                                        filteredAppointments.map((appointment) => {
                                            ...
                                            const isPhysician = specialization === "Physician";
                                            const certificateLabel = "Generate medical certificate";
